// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SwaggerAuthorizeExtensions.cs" company="DTV-Online">
...
namespace NModbusRTU.Extensions
{
    ...
    public static class SwaggerAuthorizeExtensions
    {
        ...
        /// <summary>
        /// Static property holding the current user authentication state.
        /// </summary>
        ...
        public class SwaggerAuthorizedMiddleware
        {
            ...
            {
                if (context.Request.Path.StartsWithSegments("/swagger") && !IsUserAuthenticated)
                {
