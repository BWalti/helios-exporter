...
namespace NModbusRTU.Controllers
{
    ...
    public class RWArrayController : ControllerBase
    {
        ...
        public async Task<IActionResult> ReadBoolArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadBytesAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadShortArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadUShortArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadInt32ArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadUInt32ArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadFloatArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadDoubleArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadLongArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadULongArrayAsync(ushort offset, ushort number, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, number);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteBoolArrayAsync([FromBody, Required] ModbusDataValues<bool> data, ushort offset, byte? slave = null)
        {
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteBytesAsync([FromBody, Required] ModbusDataValues<byte> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteShortArrayAsync([FromBody, Required] ModbusDataValues<short> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
            return await this.ModbusWriteArrayRequest(_logger, request, data.Values, "WriteShortArrayAsync");
        }
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteUShortArrayAsync([FromBody, Required] ModbusDataValues<ushort> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
            return await this.ModbusWriteArrayRequest(_logger, request, data.Values, "WriteUShortArrayAsync");
        }
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteInt32ArrayAsync([FromBody, Required] ModbusDataValues<int> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
            return await this.ModbusWriteArrayRequest(_logger, request, data.Values, "WriteInt32ArrayAsync");
        }
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteUInt32ArrayAsync([FromBody, Required] ModbusDataValues<uint> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
            return await this.ModbusWriteArrayRequest(_logger, request, data.Values, "WriteUInt32ArrayAsync");
        }
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteFloatArrayAsync([FromBody, Required] ModbusDataValues<float> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteDoubleArrayAsync([FromBody, Required] ModbusDataValues<double> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteLongArrayAsync([FromBody, Required] ModbusDataValues<long> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteULongArrayAsync([FromBody, Required] ModbusDataValues<ulong> data, ushort offset, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, data.Values.Length);
