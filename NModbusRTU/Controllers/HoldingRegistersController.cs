...
namespace NModbusRTU.Controllers
{
    ...
    public class HoldingRegistersController : ControllerBase
    {
        ...
        public async Task<IActionResult> ReadHoldingRegistersAsync(ushort offset, ushort number, byte? slave = null)
        {
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteHoldingRegistersAsync([FromBody, Required] ModbusDataValues<ushort> data, ushort offset, byte? slave = null)
        {
