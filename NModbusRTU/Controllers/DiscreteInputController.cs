// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InputController.cs" company="DTV-Online">
...
namespace NModbusRTU.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class DiscreteInputController : ControllerBase
    {
        ...
        public DiscreteInputController(IConfiguration configuration, ILogger<DiscreteInputController> logger)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> ReadInputAsync(ushort offset, byte? slave = null)
        {
            ...
            return await this.ModbusReadRequest(_logger, request, "ReadInputAsync");
        }
    }
}
