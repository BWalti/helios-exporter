...
namespace NModbusRTU.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class HoldingRegisterController : ControllerBase
    {
        ...
        public async Task<IActionResult> ReadHoldingRegisterAsync(ushort offset, byte? slave = null)
        {
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteHoldingRegisterAsync(ushort offset, ushort data, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusMasterData(_settings), new ModbusSlaveData(_settings, slave), offset, 1);
