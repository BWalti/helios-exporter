...
namespace ModbusTCP.Controllers
{
    ...
    public class CoilsController : ControllerBase
    {
        ...
        public async Task<IActionResult> ReadCoilsAsync(int offset, int number, string address = null, int? port = null, byte? slave = null)
        {
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteCoilsAsync([FromBody, Required] ModbusDataValues<bool> data, ushort offset, string address = null, int? port = null, byte? slave = null)
        {
