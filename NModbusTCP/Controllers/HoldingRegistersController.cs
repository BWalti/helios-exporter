// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HoldingRegistersController.cs" company="DTV-Online">
...
namespace ModbusTCP.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class HoldingRegistersController : ControllerBase
    {
        ...
        public HoldingRegistersController(IConfiguration configuration, ILogger<HoldingRegistersController> logger)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> ReadRegistersAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadHoldingRegistersAsync");
        }
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteRegistersAsync([FromBody, Required] ModbusDataValues<ushort> data, ushort offset, string address = null, int? port = null, byte? slave = null)
        {
            ...
            return await this.ModbusWriteArrayRequest(_logger, request, data.Values, "WriteHoldingRegistersAsync");
        }
    }
}
