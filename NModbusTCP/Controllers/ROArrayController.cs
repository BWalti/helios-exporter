...
namespace ModbusTCP.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ROArrayController : ControllerBase
    {
        ...
        public ROArrayController(IConfiguration configuration, ILogger<ROArrayController> logger)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Reads an array of boolean values (multiple discrete inputs) from a Modbus slave.
        /// </summary>
        ...
        /// <response code="400">If an error or an unexpected exception occurs.</response>
        [HttpGet("Bool/{offset}")]
        ...
        public async Task<IActionResult> ReadOnlyBoolArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyBoolArrayAsync");
        }

        /// <summary>
        /// Reads 8-bit values (multiple input register) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyBytesAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyBytesAsync");
        }

        /// <summary>
        /// Reads an array of 16 bit integers (multiple input register) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyShortArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyShortArrayAsync");
        }

        /// <summary>
        /// Reads an array of unsigned 16 bit integer (multiple input register) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of the Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyUShortArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyUShortArrayAsync");
        }

        /// <summary>
        /// Reads an array of 32 bit integers (multiple input registers) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of the Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyInt32ArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyInt32ArrayAsync");
        }

        /// <summary>
        /// Reads an array of unsigned 32 bit integers (multiple input registers) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of the Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyUInt32ArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyUInt32ArrayAsync");
        }

        /// <summary>
        /// Reads an array of 32 bit IEEE floating point numbers (multiple input registers) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of the Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyFloatArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyFloatArrayAsync");
        }

        /// <summary>
        /// Reads an array of 64 bit IEEE floating point numbers (multiple input registers) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of the Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyDoubleArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyDoubleArrayAsync");
        }

        /// <summary>
        /// Reads an array of 64 bit integers (multiple input registers) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of the Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyLongArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyLongArrayAsync");
        }

        /// <summary>
        /// Reads an array of unsigned 64 bit integers (multiple input registers) from a Modbus slave.
        /// </summary>
        /// <param name="offset">The Modbus address (offset) of the first data value.</param>
        /// <param name="number">The number of the Modbus data values.</param>
        /// <param name="address">The IP address of the Modbus TCP slave.</param>
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> ReadOnlyULongArrayAsync(ushort offset, ushort number, string address = null, int? port = null, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData(new ModbusSlaveData(_settings, address, port, slave), offset, number);
            return await this.ModbusReadRequest(_logger, request, "ReadOnlyULongArrayAsync");
        }
